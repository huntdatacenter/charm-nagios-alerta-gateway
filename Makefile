...
SHELL := /bin/bash
# Charm variables
CHARM_NAME := nagios-alerta-gateway
CHARM_STORE_URL := cs:~huntdatacenter/nagios-alerta-gateway
CHARM_HOMEPAGE := https://github.com/huntdatacenter/charm-nagios-alerta-gateway/
CHARM_BUGS_URL := https://github.com/huntdatacenter/charm-nagios-alerta-gateway/issues
